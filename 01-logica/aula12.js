...
const soma = vetor.reduce((estado, item) => estado + item, 0);  /* A notação ',0' ao final da função é o estado inicial, no caso 0, porque buscamos a somatória */

const produto = vetor.reduce((estado, item) => estado * item, 1); /* Note que o estado inicial aqui, por ser produto, é 1 */
